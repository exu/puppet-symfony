...
exec "Snippet class /**<CR> * classname:".st."ClassName".et."<CR>* @author Leszek Prabucki <leszek.prabucki@goyello.com><CR> */<CR>class ".st."ClassName".et    ."<CR>{<CR>/**<CR>* constructor<CR>*/<CR>function __construct ( ".st."argument".et.")<CR>{<CR>".st.et."<CR>}<CR>###<CR><CR>}<CR>###".st.et
exec "Snippet classe /**<CR> * classname:".st."ClassName".et."<CR>* @author Leszek Prabucki <leszek.prabucki@goyello.com><CR> **/<CR>class ".st."ClassName".et." extends ".st."extendsAnotherClass".et."<CR>{<CR>#internal variables<CR><CR>#Constructor<CR>function __construct ( ".st."argument".et.")<CR>{<CR>".st.et."    <CR>}<CR>###<CR><CR>}<CR>###".st.et
